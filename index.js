...
// Keeping your main handler object completely intact
const mainWorker = {
...
// --- EXPRESS ROUTING BRIDGE FOR RENDER ---
const app = express();
...
app.all('*', async (req, res) => {
  ...
  try {
    // Reconstruct the environment object if your app needs it, otherwise passing an empty object
...
app.listen(PORT, () => {
  console.log(`Anivexa API is listening on port ${PORT}`);
});
